...
# foward(n) moves the turtle foward n pixels.
...
# colors[i %len(colors)] cycles throught the color list endlessly.
...
#begin_fill() + end_fill() fills the shape with chosen color.
